...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate a UNet2D checkpoint on ACDC/MSCMR")
...
def evaluate(args):
    ...
    if dataset_name not in ("ACDC", "MSCMR"):
        raise ValueError("test_pce_2d.py only evaluates ACDC/MSCMR checkpoints; use test_pce_3d.py for WORD")
